...
$lang = array_merge($lang, [
   ...
   'ACP_PMWELCOME_EXPLAIN'         => 'Puedes especificar el texto del mensaje personal que será enviado al usuario en el momento que se inscriba.',
   ...
   'ACP_PMWELCOME_TEXT_EXPLAIN'   => 'Puedes usar BBCode y emoticonos, o {USERNAME} para reemplazar el nombre del usuario que recibe un mensaje privado, {USER_EMAIL} para reemplazar el email del usuario que recibe un mensaje privado, {SITE_NAME} y {SITE_DESC} para reemplazar el nombre y descripción de tu foro, {BOARD_CONTACT}, {BOARD_EMAIL} y {BOARD_SIG} para reemplazar el contacto, correo electrónico y firma de tu foro, así como {SENDER} para insertar el nombre del remitente.',
